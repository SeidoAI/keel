"""`agent-project node check` — concept node freshness check.
...
from agent_project.core.freshness import check_all_nodes, check_node_freshness
from agent_project.core.node_store import load_node
...
def node_check_cmd(node_id: str | None, project_dir: Path, output_format: str) -> None:
    ...
    if node_id is not None:
        ...
        from agent_project.core.node_store import list_nodes
