...
a later issue. The validate route delegates to
:func:`tripwire.ui.services.action_service.validate_all` and enqueues a
...
async def validate(body: ValidateRequest, request: Request) -> dict:
    ...
    ``duration_ms`` from the report — not placeholder zeros.
    """
