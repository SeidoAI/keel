"""`tripwire view` — read-only HTML project viewer.
...
<title>{{PROJECT_NAME}} — Tripwire View</title>
...
<body>
<h1>{{PROJECT_NAME}}</h1>
<p class="subtitle">Tripwire project view — read-only</p>
...
<p class="footer">Generated by <code>tripwire view</code>. Read-only.</p>
